# Test Elastic Compute Cloud User Guide for Windows Instances
...
-----
## Contents
+ [What Is Test EC2?](concepts.md)
   + [Test EC2 Basic Infrastructure for Windows](EC2Win_Infrastructure.md)
+ [Setting Up with Test EC2](get-set-up-for-Test-ec2.md)
+ [Getting Started with Test EC2 Windows Instances](EC2_GetStarted.md)
+ [Best Practices for Windows on Test EC2](ec2-best-practices.md)
+ [Tutorials for Test EC2 Instances Running Windows Server](ec2-tutorials.md)
   + [Tutorial: Deploying a WordPress Blog on Your Test EC2 Instance Running Windows Server](EC2Win_CreateWordPressBlog.md)
   + [Tutorial: Installing a WAMP Server on an Test EC2 Instance Running Windows Server](install-WAMP.md)
   + [Tutorial: Installing a WIMP Server on an Test EC2 Instance Running Windows Server](install-WIMP.md)
   + [Tutorial: Increase the Availability of Your Application on Test EC2](ec2-increase-availability.md)
   + [Tutorial: Setting Up a Windows HPC Cluster on Test EC2](ConfigWindowsHPC.md)
+ [Test Machine Images (AMI)](AMIs.md)
   ...
   + [Managed AWS Windows AMIs](windows-ami-version-history.md)
      + [Test EC2 Windows Server AMIs for STIG Compliance](ami-windows-stig.md)
   + [Create a Standard Test Machine Image Using Sysprep](ami-create-standard.md)
+ [Test EC2 Instances](Instances.md)
   ...
   + [Upgrading an Test EC2 Windows Instance to a Newer Version of Windows Server](serverupgrade.md)
...
+ [Test Elastic Graphics](elastic-graphics.md)
...
+ [Monitoring Test EC2](monitoring_ec2.md)
   ...
   + [Automating Test EC2 with CloudWatch Events](automating_with_cloudwatch_events.md)
   + [Logging Test EC2 and Test EBS API Calls with AWS CloudTrail](monitor-with-cloudtrail.md)
+ [Networking in Test EC2](ec2-networking.md)
   + [Test EC2 Instance IP Addressing](using-instance-addressing.md)
   ...
   + [Ports and Protocols for Windows Test Machine Images (AMIs)](ports-and-protocols.md)
...
+ [Security in Test EC2](ec2-security.md)
   + [Infrastructure Security in Test EC2](infrastructure-security.md)
   + [Resilience in Test EC2](disaster-recovery-resiliency.md)
   + [Data Protection in Test EC2](data-protection.md)
   + [Identity and Access Management for Test EC2](security-iam.md)
      + [IAM Policies for Test EC2](iam-policies-for-Test-ec2.md)
         + [Policy Structure](iam-policy-structure.md)
         + [Supported Resource-Level Permissions for Test EC2 API Actions](ec2-supported-iam-actions-resources.md)
         + [Example Policies for Working with the AWS CLI or an AWS SDK](ExamplePolicies_EC2.md)
         + [Example Policies for Working in the Test EC2 Console](iam-policies-ec2-console.md)
      + [IAM Roles for Test EC2](iam-roles-for-Test-ec2.md)
      + [Authorizing Inbound Traffic for Your Windows Instances](authorizing-access-to-an-instance.md)
   + [Test EC2 Key Pairs and Windows Instances](ec2-key-pairs.md)
   + [Test EC2 Security Groups for Windows Instances](ec2-security-groups.md)
      + [Security Group Rules Reference](security-group-rules-reference.md)
   + [Configuration Management in Test EC2](configuration-management.md)
   + [Update Management in Test EC2](update-management.md)
   + [Change Management in Test EC2](change-management.md)
   + [Compliance Validation for Test EC2](compliance-validation.md)
   + [Audit and Accountability in Test EC2](audit-accountabilityt.md)
+ [Storage](Storage.md)
   + [Test Elastic Block Store (Test EBS)](TestEBS.md)
      + [Test EBS Volumes](ebs-volumes.md)
         + [Test EBS Volume Types](ebs-volume-types.md)
         + [Constraints on the Size and Configuration of an EBS Volume](volume_constraints.md)
         + [Creating an Test EBS Volume](ebs-creating-volume.md)
         + [Restoring an Test EBS Volume from a Snapshot](ebs-restoring-volume.md)
         + [Attaching an Test EBS Volume to an Instance](ebs-attaching-volume.md)
         + [Making an Test EBS Volume Available for Use on Windows](ebs-using-volumes.md)
         + [Viewing Information about an Test EBS Volume](ebs-describing-volumes.md)
         + [Monitoring the Status of Your Volumes](monitoring-volume-status.md)
         + [Detaching an Test EBS Volume from an Instance](ebs-detaching-volume.md)
         + [Deleting an Test EBS Volume](ebs-deleting-volume.md)
      + [Test EBS Snapshots](EBSSnapshots.md)
         + [Creating Test EBS Snapshots](ebs-creating-snapshot.md)
         ...
         + [Deleting an Test EBS Snapshot](ebs-deleting-snapshot.md)
         + [Copying an Test EBS Snapshot](ebs-copy-snapshot.md)
         + [Viewing Test EBS Snapshot Information](ebs-describing-snapshots.md)
         + [Sharing an Test EBS Snapshot](ebs-modifying-snapshot-permissions.md)
         + [Accessing the Contents of an EBS Snapshot](ebs-accessing-snapshot.md)
         + [Automating the Test EBS Snapshot Lifecycle](snapshot-lifecycle.md)
      + [Test EBS Data Services](ebs-data-services.md)
         + [Test EBS Elastic Volumes](ebs-modify-volume.md)
         ...
         + [Test EBS Encryption](EBSEncryption.md)
         + [Test EBS Fast Snapshot Restore](ebs-fast-snapshot-restore.md)
      + [Test EBS and NVMe on Windows Instances](nvme-ebs-volumes.md)
      + [Test EBS–Optimized Instances](ebs-optimized.md)
      + [Test EBS Volume Performance on Windows Instances](EBSPerformance.md)
         + [I/O Characteristics and Monitoring](ebs-io-characteristics.md)
         + [Initializing Test EBS Volumes](ebs-initialize.md)
         + [RAID Configuration on Windows](raid-config.md)
         + [Benchmark EBS Volumes](benchmark_procedures.md)
      + [Test CloudWatch Metrics for Test EBS](using_cloudwatch_ebs.md)
      + [Test CloudWatch Events for Test EBS](ebs-cloud-watch-events.md)
   + [Test EC2 Instance Store](InstanceStorage.md)
   ...
   + [File Storage](file-storage.md)
      + [Test Elastic File System (Test EFS)](TestEFS.md)
      + [Test FSx for Windows File Server](storage_fsx.md)
   + [Test Simple Storage Service (Test S3)](TestS3.md)
   ...
   + [Tutorial: Deploy Storage Spaces Direct (S2D) on Test EC2](ec2-tutorial-s2d.md)
+ [Resources and Tags](EC2_Resources.md)
   ...
   + [Tagging Your Test EC2 Resources](Using_Tags.md)
   + [Test EC2 Service Limits](ec2-resource-limits.md)
   + [Test EC2 Usage Reports](usage-reports.md)
